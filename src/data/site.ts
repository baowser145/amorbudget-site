...
export const site = {
  ...
  /**
   * Shopify storefront (LGTM merch).
   * Paste the live URL when the store is ready, e.g.
   *   'https://wearlgtm.myshopify.com'
   *   'https://wearlgtm.com'
   * Leave empty to show the "coming soon" state on Merch.
   */
  shop: {
    url: '',
    brand: 'LGTM',
    label: 'Shop LGTM',
    blurb:
      'Tees and everyday gear from LGTM — same crew behind Amor Budget.',
  },
